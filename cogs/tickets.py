...
class CategorySelect(discord.ui.Select):
    def __init__(self):
        ...
        super().__init__(placeholder="Select ticket category...", options=options, custom_id="cat_select_v13")
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        configs = {
            "Base Buying": {
                ...
                "q": ["What type of base?", "Your budget?", "Requirements?"]
            },
            "Bedrock Hole Buying": {
                "cat": "Bedrock Holes", "ping": [STAFF_ROLE, BEDROCK_ROLE], "allow": [STAFF_ROLE, BEDROCK_ROLE],
                "color": 0x95a5a6, "emoji": "🕳️",
                "q": ["What size hole?", "Your budget?", "Location?"]
            },
            "Spawner Trading": {
            ...
            "Building": {
                "cat": "Building", "ping": [BUILDING_ROLE], "allow": [STAFF_ROLE, BUILDING_ROLE],
            ...
            "Scam Report": {
                "cat": "Scam Reports", "ping": [STAFF_ROLE], "allow": [STAFF_ROLE],
